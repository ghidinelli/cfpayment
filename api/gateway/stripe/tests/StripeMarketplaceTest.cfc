...
--->
	...
	<cffunction name="testMarketplaceCreateConnectedAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.connectedAccount = arguments.gw.marketplaceCreateConnectedAccount() />
	...
	<cffunction name="testMarketplaceUpdateConnectedAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		<cfargument name="gw" type="any" required="true" />
		<cfset local.newEmail = "test#dateFormat(now(), 'yyyymmdd')##timeFormat(now(), 'HHmmss')#@test.test" />
		...
		<cfset local.update = arguments.gw.marketplaceUpdateConnectedAccount(connectedAccount = connectedAccount.getParsedResult().id, updates = ["legal_entity[first_name]=John","legal_entity[last_name]=Smith","email=#local.newEmail#"]) />
	...
	<cffunction name="testMarketplaceListConnectedAccounts" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.list = arguments.gw.marketplaceListConnectedAccounts() />
	...
	<cffunction name="testMarketplaceConnectedAccountUserDataPopulation" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().id />
		<cfset local.argumentCollection.updates = ["legal_entity[first_name]=John","legal_entity[last_name]=Smith","email=#local.newEmail#"] />
		<cfset local.update = arguments.gw.marketplaceUpdateConnectedAccount(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.update, expectedObjectName = "account", expectedIdPrefix="acct_") />
	</cffunction>
	...
	<cffunction name="testMarketplaceConnectedAccountUserDataPopulationWithInvalidFieldsThrowsError" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.update = arguments.gw.marketplaceUpdateConnectedAccount(connectedAccount = local.connectedAccount.getParsedResult().id, updates = ["legal_entity[invalid_field]=fail"]) />
	...
	<cffunction name="testMarketplaceNewlyCreatedConnectedAccountHasCorrectLegalEntityFieldsNeeded" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfloop list="legal_entity.first_name,legal_entity.last_name,legal_entity.dob.day,legal_entity.dob.month,legal_entity.dob.year,legal_entity.type,legal_entity.address.line1,legal_entity.address.city,legal_entity.address.state,legal_entity.address.postal_code,bank_account,tos_acceptance.ip,tos_acceptance.date" index="local.fieldNeeded">
	...
	<cffunction name="testMarketplaceNewlyCreatedConnectedAccountCorrectlyPopulatedReturnsNoValidationFieldsNeeded" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.bankAccount = arguments.gw.marketplaceCreateBankAccount(connectedAccount = local.connectedAccount.getParsedResult().id, account = createAccount()) />
		...
		<cfset local.update = arguments.gw.marketplaceUpdateConnectedAccount(connectedAccount = local.connectedAccount.getParsedResult().id, updates = local.fieldsNeeded) />
		<cfset standardResponseTests(response = local.update, expectedObjectName = "account", expectedIdPrefix="acct_") />
	...
	<cffunction name="testFetchBankAccounts" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.bankAccounts = arguments.gw.marketplaceFetchBankAccounts(connectedAccount = local.connectedAccount.getParsedResult().id) />
	...
	<cffunction name="testUpdateBankAccountDefaultForCurrency" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.update = arguments.gw.marketplaceUpdateBankAccountDefaultForCurrency(connectedAccount = local.connectedAccount.getParsedResult().id, bankAccountId = local.bankAccount.getParsedResult().id) />
		<cfset standardResponseTests(response = local.update, expectedObjectName = "bank_account", expectedIdPrefix="ba_") />
		<cfset assertTrue(local.update.getSuccess() AND structKeyExists(local.update.getParsedResult(), "default_for_currency") AND local.update.getParsedResult().default_for_currency eq true, "Default for currency not set to true") />
	</cffunction>
	...
	<cffunction name="testDeleteBankAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.delete = arguments.gw.marketplaceDeleteBankAccount(connectedAccount = local.connectedAccount.getParsedResult().id, bankAccountId = local.bankAccount.getParsedResult().id) />
		<cfset standardResponseTests(response = local.delete, expectedObjectName = "", expectedIdPrefix="ba_") />
		<cfset assertTrue(local.delete.getSuccess() AND structKeyExists(local.delete.getParsedResult(), "deleted") AND local.delete.getParsedResult().deleted eq true, "Failed to delete the second (not default for currency) bank account") />
	</cffunction>
	...
	<cffunction name="testUploadIdentityFile" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.uploadFile = arguments.gw.marketplaceUploadIdentityFile(file = variables.filePathToSampleLicence) />
	...
	<cffunction name="testAttachFileToAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset offlineInjector(arguments.gw, this, "mock_upload_identity_file_ok", "doHttpCall") />
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.file = variables.filePathToSampleLicence />
		<cfset local.argumentCollection.accountSecret = local.connectedAccount.getParsedResult().keys.secret />
		<cfset local.uploadFile = arguments.gw.marketplaceUploadIdentityFile(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.uploadFile, expectedObjectName = "file_upload", expectedIdPrefix="file_") />
		...
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().id />
		<cfset local.argumentCollection.accountSecret = local.connectedAccount.getParsedResult().keys.secret />
		<cfset local.argumentCollection.fileId = local.uploadFile.getParsedResult().id />
		<cfset offlineInjector(arguments.gw, this, "mock_attach_file_to_account_ok", "doHttpCall") />
		<cfset local.attachFile = arguments.gw.marketplaceAttachFileToAccount(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.attachFile, expectedObjectName = "account", expectedIdPrefix="acct_") />
		<cfset assertTrue(local.uploadFile.getParsedResult().id eq local.attachFile.getParsedResult()["legal_entity"]["verification"]["document"], "Identity file not attached to account") />
	</cffunction>
	...
	<cffunction name="testCharge" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.token = arguments.gw.createToken(createCard()) />
		...
		<cfset local.argumentCollection.source = local.token.getParsedResult().id>
		<cfset local.argumentCollection.description = 'unit-test charge'>
		<cfset offlineInjector(arguments.gw, this, "mock_charge_ok", "doHttpCall") />
		<cfset local.charge = arguments.gw.charge(argumentCollection = local.argumentCollection) />
	...
	<cffunction name="testDirectCharge" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.customer = arguments.gw.store(createCard()) />
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().keys.secret />
		<cfset local.argumentCollection.amount = variables.svc.createMoney(1000, arguments.gw.currency) />
		<cfset local.argumentCollection.token = local.customerToken.getParsedResult().id />
		...
		<cfset local.charge = arguments.gw.marketplaceDirectCharge(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.charge, expectedObjectName = "charge", expectedIdPrefix="ch_") />
	</cffunction>
	...
	<cffunction name="testRefundCharge" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<!--- Refund Charge --->
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.paymentId = local.charge.getParsedResult().id />
		<cfset local.argumentCollection.refundAmount = variables.svc.createMoney(300, arguments.gw.currency) />
		<cfset offlineInjector(arguments.gw, this, "mock_refund_charge_ok", "doHttpCall") />
		<cfset local.refund = arguments.gw.marketplaceRefundCharge(argumentCollection = local.argumentCollection) />
	...
	<cffunction name="testRefundChargeToConnectedAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.paymentId = local.charge.getParsedResult().id />
		<cfset local.argumentCollection.refundAmount = variables.svc.createMoney(250, arguments.gw.currency) />
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().id />
		<cfset offlineInjector(arguments.gw, this, "mock_refund_charge_to_connected_account_ok", "doHttpCall") />
		<cfset local.refund = arguments.gw.marketplaceRefundChargeToConnectedAccount(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.refund, expectedObjectName = "refund", expectedIdPrefix="re_") />
	</cffunction>
	...
	<cffunction name="testRefundToAccountPullingBackFundsFromConnectedAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.paymentId = local.charge.getParsedResult().id />
		<cfset local.argumentCollection.refundAmount = variables.svc.createMoney(400, arguments.gw.currency) />
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().id />
		<cfset offlineInjector(arguments.gw, this, "mock_refund_to_account_pulling_back_funds_from_connected_account_ok", "doHttpCall") />
		<cfset local.refund = arguments.gw.marketplaceRefundToAccountPullingBackFundsFromConnectedAccount(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.refund, expectedObjectName = "refund", expectedIdPrefix="re_") />
	</cffunction>
	...
	<cffunction name="testTransferFromPlatformStripeAccountToConnectedStripeAccount" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.destination = local.connectedAccount.getParsedResult().id>
		<cfset local.argumentCollection.transferAmount = variables.svc.createMoney(500, arguments.gw.currency)>
		...
		<cfset local.transfer = arguments.gw.marketplaceTransferFromPlatformStripeAccountToConnectedStripeAccount(argumentCollection = local.argumentCollection) />
	...
	<cffunction name="testAssociateTransferWithCharge" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.destination = local.connectedAccount.getParsedResult().id>
		<cfset local.argumentCollection.sourceTransaction = local.charge.getParsedResult().id>
		<cfset local.argumentCollection.transferAmount = variables.svc.createMoney(500, arguments.gw.currency)>
		<cfset offlineInjector(arguments.gw, this, "mock_transfer_from_platform_stripe_account_to_connected_stripe_account_ok", "doHttpCall") />
		<cfset local.transfer = arguments.gw.marketplaceTransferFromPlatformStripeAccountToConnectedStripeAccount(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.transfer, expectedObjectName = "transfer", expectedIdPrefix="tr_") />
	...
	<cffunction name="testTransferWithApplicationFee" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection.destination = local.connectedAccount.getParsedResult().id>
		<cfset local.argumentCollection.transferAmount = variables.svc.createMoney(500, arguments.gw.currency)>
		<cfset local.argumentCollection.applicationFee = variables.svc.createMoney(200, arguments.gw.currency)>
		<cfset offlineInjector(arguments.gw, this, "mock_transfer_with_application_fee_ok", "doHttpCall") />
		<cfset local.transfer = arguments.gw.marketplaceTransferWithApplicationFee(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.transfer, expectedObjectName = "transfer", expectedIdPrefix="tr_") />
	</cffunction>
	...
	<cffunction name="testReversingTransfer" access="public" returntype="void" output="false" mxunit:dataprovider="gateways">
		...
		<cfset local.argumentCollection = structNew()>
		<cfset local.argumentCollection.paymentId = local.transfer.getParsedResult().destination_payment>
		<cfset local.argumentCollection.connectedAccount = local.connectedAccount.getParsedResult().id>
		<cfset local.argumentCollection.amount = variables.svc.createMoney(400, arguments.gw.currency)>
		<cfset offlineInjector(arguments.gw, this, "mock_reversing_transfer_ok", "doHttpCall") />
		<cfset local.refund = arguments.gw.marketplaceReversingTransfer(argumentCollection = local.argumentCollection) />
		<cfset standardResponseTests(response = local.refund, expectedObjectName = "refund", expectedIdPrefix="pyr_") />
	</cffunction>
	...
	<cffunction name="createAccount" access="private" returntype="any" output="false">
		...
		<cfset local.account.setCountry("Canada") />
		...
		<cfset local.account.setCheckNumber() />
		<cfset local.account.setAccountType() />
		<cfset local.account.setSEC() />
